...
# First get metadata with sample_id column
metadata_ps1 <- sample_data(ps1) %>%
  as.data.frame() %>%
...
# Convert sample_data to data frame and preserve rownames as sample_id
metadata_df <- sample_data(ps2) %>%
  as.data.frame() %>%
  rownames_to_column("sample_id")
